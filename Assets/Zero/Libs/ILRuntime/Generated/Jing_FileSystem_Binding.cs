...
{
    unsafe class Jing_FileSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Jing.FileSystem);
            ...
            app.RegisterCLRMethodRedirection(method, CombineDirs_1);
        ...
        static StackObject* CombinePaths_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Jing.FileSystem.CombinePaths(@args);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* CombineDirs_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = Jing.FileSystem.CombineDirs(@isEndWithBackslash, @args);
